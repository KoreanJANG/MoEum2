...
#220621 수정: 네이버 쇼핑 API 오류 -> 이미 완성된 json 데이터에 접속한 것이라 굳이 bs로 뽑아올 필요 없음(뽑으면서 충돌)
...
# User_url = 'https://link.naver.com/bridge?url=https%3A%2F%2Fn.news.naver.com%2Farticle%2F214%2F0001204095&dst=na'
# User_url = "https://n.news.naver.com/article/214/0001204095"

# ---------------test_completed_below-----------------
# User_url = 'http://naver.me/FJFjDCDS' #뉴스
# User_url = 'http://naver.me/GZ0VX04A' #카페(비로그인)
# User_url = 'http://naver.me/F8BI4nh2' #블로그
# User_url = 'http://naver.me/xQoDsIfW' #쇼핑
# User_url = 'https://search.shopping.naver.com/catalog/29413009627?query=%EC%97%90%EC%96%B4%ED%8C%9F3%EC%84%B8%EB%8C%80&NaPm=ct%3Dl4o1ua4g%7Cci%3D7dfa1baa6ffd4a7a69c21d74fb5fceb2b1dd4780%7Ctr%3Dslsl%7Csn%3D95694%7Chk%3D663c048f0c3c0138b4709ca30b639ef31826f615'
# User_url = 'https://msearch.shopping.naver.com/catalog/23871415424?NaPm=ct%3Dl4nyvh7s%7Cci%3Dcbabcc9db6420b3af41' #msearch
...
# User_url = 'https://www.instagram.com/p/Ce-4dNjPL8E/?igshid=YzAyZWRlMzg='
...
# User_url = 'https://front.wemakeprice.com/deal/627767367'
...
# 쇼핑 Distributor 주요 0개사 지정
    ...
    # 위메프(js_sele)
        ...
        # 드라이버 생성 #라니 오픈(제이 경로 클로즈)
        chromedriver = 'D/moEum/nodejs-book-master/ch9/9.5.6_파이썬 연동 처리/9.5.4_검색_삭제처리_완료/nodebird/chromedriver.exe'  # 윈도우
#         chromedriver = 'C:/Users/FNUCNI/chromedriver.exe' # 윈도우 # 제이 경로
        # chromedriver = '/usr/local/Cellar/chromedriver/chromedriver' # 맥
